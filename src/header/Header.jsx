...
function Header() {
  ...
  return (
    ...
    <nav >
    <img src="https://img.icons8.com/?size=100&id=8113&format=png"
    isMenuOpen={isMenuOpen} onClick={()=>setIsMenuOpen(!isMenuOpen)}
    className='menu z-20 transition ease-in-out delay-500'
    />
